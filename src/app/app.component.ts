...
import {
  CellBodyDirective,
   CellHeaderDirective,
  ClientSidePaginatedPostsComponent, RowComponent
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, PostListComponent, PaginatedPostsComponent, ClientSidePaginatedPostsComponent, MatCell, MatCellDef, MatColumnDef, MatHeaderCell, AsyncPipe, MatHeaderCellDef, RowComponent, CellBodyDirective, CellHeaderDirective],
